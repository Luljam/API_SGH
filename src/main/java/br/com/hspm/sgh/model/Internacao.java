...
public class Internacao {
	...
	public String getNr_crm_profissional() {
		return nr_crm_profissional;
	}
	public void setNr_crm_profissional(String nr_crm_profissional) {
	...
	public String getNr_procedimento() {
	...
	public String getDc_tipo_alta_medica() {
		return dc_tipo_alta_medica;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((dc_tipo_alta_medica == null) ? 0 : dc_tipo_alta_medica.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (cd_prontuario == null) {
			...
			return false;
		if (dc_tipo_alta_medica == null) {
			if (other.dc_tipo_alta_medica != null)
				return false;
		} else if (!dc_tipo_alta_medica.equals(other.dc_tipo_alta_medica))
			return false;
