	...
	public static Paciente paciente(Long _prontuario) {
		...
		try {
			...
			if (resultSet.next()) {
				...
				paciente.setDc_complemento_logradouro(resultSet.getString("dc_complemento_logradouro"));
				...
				paciente.setDdd_fone_comercial(resultSet.getInt("ddd_fone_comercial"));
				paciente.setFone_comercial(resultSet.getLong("fone_comercial"));
